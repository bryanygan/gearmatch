...
export const pulsarX2: MouseProduct = {
  ...
  manufacturer_url: "https://www.pulsar.gg/collections/x2-series",
  recommendation_tags: [
    "competitive_fps",
    "ultralight",
    "safe_shape",
...
export const endgameGearOp1_8k: MouseProduct = {
  ...
  manufacturer_url: "https://www.endgamegear.com/en-us/gaming-mice/op1-8k",
  recommendation_tags: [
    "competitive_fps",
    "wired",
    "ultralight",
...
export const hitscanHyperlight: MouseProduct = {
  ...
  manufacturer_url: "https://hitscan.com/products/hyperlight",
  recommendation_tags: [
    "ultralight",
    "competitive_fps",
    "fingertip_claw",
...
export const scyroxV8: MouseProduct = {
  ...
  manufacturer_url: "https://scyrox.com/products/scyrox-v8-mouse-ptfe-skate",
  recommendation_tags: [
    "competitive_fps",
    "ultralight",
    "wireless_gaming",
...
export const ninjutsoSoraV2: MouseProduct = {
  ...
  manufacturer_url: "https://ninjutso.com/products/ninjutso-sora-v2",
  recommendation_tags: [
    "competitive_fps",
    "ultralight",
    "wireless_gaming",
...
export const endgameGearOp1_8kV2: MouseProduct = {
  ...
  manufacturer_url: "https://www.endgamegear.com/en-us/gaming-mice/op1w-4k-v2",
  recommendation_tags: [
    "competitive_fps",
    "wired",
    "ultralight",
...
export const mchoseL7Ultra: MouseProduct = {
  ...
  manufacturer_url: "https://www.mchose.store/products/mchose-l7-series-ultra-lightweight-wireless-gaming-mouse",
  recommendation_tags: [
    "competitive_fps",
    "ultralight",
    "safe_shape",
...
export const threeDconnexionCadmouseProWireless: MouseProduct = {
  ...
  core_attributes: {
    ...
    mouse_sensor_class: "basic",
    mouse_click_latency_ms: 16.8,
    mouse_sensor_latency_ms: 24.6,
    mouse_build_quality: "great",
    mouse_feet_quality: "great",
    mouse_coating: "matte",
    mouse_feel_tags: ["large_hands_friendly","ergonomic"],
    mouse_value_pick: false,
  },
};

export const logitechG203Lightsync: MouseProduct = {
  id: "logitech_g203_lightsync",
  name: "Logitech G203 LIGHTSYNC",
  brand: "Logitech",
  category: "mouse",
  ...
  core_attributes: {
    ...
    mouse_sensor_class: "good",
    mouse_click_latency_ms: undefined,
    mouse_sensor_latency_ms: 12.9,
    mouse_build_quality: "great",
    mouse_feet_quality: "good",
    mouse_coating: "matte",
    mouse_feel_tags: ["large_hands_friendly","safe_shape","ergonomic"],
    mouse_value_pick: false,
  },
};

export const logitechG305Lightspeed: MouseProduct = {
  id: "logitech_g305_lightspeed",
  name: "Logitech G305 LIGHTSPEED",
  brand: "Logitech",
  category: "mouse",
  price_range_usd: [50, 80],
  ...
  core_attributes: {
    ...
    mouse_sensor_class: "good",
    mouse_click_latency_ms: 6.3,
    mouse_sensor_latency_ms: 15.2,
    mouse_build_quality: "great",
    mouse_feet_quality: "good",
    mouse_coating: "matte",
    mouse_feel_tags: ["large_hands_friendly","safe_shape","portable"],
    mouse_value_pick: false,
  },
};

export const logitechG600MmoGaming: MouseProduct = {
  id: "logitech_g600_mmo_gaming",
  name: "Logitech G600 MMO Gaming",
  brand: "Logitech",
  category: "mouse",
  price_range_usd: [50, 80],
  ...
  core_attributes: {
    ...
    mouse_sensor_class: "good",
    mouse_click_latency_ms: undefined,
    mouse_sensor_latency_ms: 15.9,
    mouse_build_quality: "great",
    mouse_feet_quality: "great",
    mouse_coating: "matte",
    mouse_feel_tags: ["small_hands_friendly","large_hands_friendly","ergonomic"],
    mouse_value_pick: false,
  },
};

export const logitechG703LightspeedWithHeroSensor: MouseProduct = {
  id: "logitech_g703_lightspeed_with_hero_sensor",
  name: "Logitech G703 LIGHTSPEED with HERO Sensor",
  brand: "Logitech",
  category: "mouse",
  price_range_usd: [50, 80],
  image_url: "https://i.rtings.com/assets/products/xRUxJwmc/logitech-g703-lightspeed-with-hero-sensor/design-medium.jpg?format=auto",
  ...
  core_attributes: {
    ...
    mouse_sensor_class: "flagship",
    mouse_click_latency_ms: 5.2,
    mouse_sensor_latency_ms: 13,
    mouse_build_quality: "good",
    mouse_feet_quality: "good",
    mouse_coating: "matte",
    mouse_feel_tags: ["small_hands_friendly","portable"],
    mouse_value_pick: false,
  },
};

export const gWolvesHskPro4k: MouseProduct = {
  id: "g_wolves_hsk_pro_4k",
  name: "G-Wolves HSK Pro 4K",
  brand: "G-Wolves",
  category: "mouse",
  price_range_usd: [120, 160],
...
export const gloriousModelO3Wireless: MouseProduct = {
  id: "glorious_model_o3_wireless",
  name: "GLORIOUS Model O3 Wireless",
  brand: "GLORIOUS",
  category: "mouse",
  price_range_usd: [50, 80],
...
export const endgameGearOp18k: MouseProduct = {
  id: "endgame_gear_op1_8k",
  name: "Endgame Gear OP1 8k",
  brand: "Endgame",
  category: "mouse",
...
export const ploopyThumbTrackball: MouseProduct = {
  id: "ploopy_thumb_trackball",
  name: "Ploopy Thumb Trackball",
  brand: "Ploopy",
  category: "mouse",
  price_range_usd: [50, 80],
  ...
  core_attributes: {
    ...
    mouse_button_count: 6,
    mouse_button_count_class: "low",
    mouse_scroll_features: ["infinite_scroll"],
    mouse_polling_rate_max_hz: "1000",
    mouse_sensor_class: "good",
    mouse_click_latency_ms: undefined,
    mouse_sensor_latency_ms: undefined,
...
export const finalmouseUltralightxCompetition: MouseProduct = {
  id: "finalmouse_ultralightx_competition",
...
export const allMouseProducts: MouseProduct[] = [
  ...
  // New from RTINGS
  threeDconnexionCadmouseProWireless,
  logitechG203Lightsync,
  logitechG305Lightspeed,
  logitechG600MmoGaming,
  logitechG703LightspeedWithHeroSensor,
  gWolvesHskPro4k,
  gloriousModelO3Wireless,
  endgameGearOp18k,
  ploopyThumbTrackball,
  finalmouseUltralightxCompetition,
];